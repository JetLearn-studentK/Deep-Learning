...
def mouseDrawing(event):
    ...
    #number.ellipse((event.x, event.y, event.x + 5, event.y + 5), "#1c6537")
    number.line((lastX, lastY, event.x, event.y), "#1c6537", 5)
...
blankImage = Image.new(mode = "L", size = (250, 250), color = "black")
